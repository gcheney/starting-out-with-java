...
public class CoffeeDBViewer extends JFrame
{
   ...
   */
   ...
   private void buildQueryPanel()
   {
      ...
      queryPanel.add(qaScrollPane, BorderLayout.CENTER);
      queryPanel.setBorder(BorderFactory.createEmptyBorder(35,10,35,10));
   }
   ...
   */
   ...
   /*
   //SQL statement to use for viewing
   SELECT 
