...
public class LayoutManager3 extends JFrame {
	...
	public LayoutManager3(){
		...
		this.addComp(thePanel, nameLabel, 0, 0, 1, 1, GridBagConstraints.EAST, GridBagConstraints.NONE);
		
		nameText = new JTextField(30);	
		this.addComp(thePanel, nameText, 1, 0, 2, 1, GridBagConstraints.WEST, GridBagConstraints.NONE);
		
		streetLabel = new JLabel("  Street:");		
		this.addComp(thePanel, streetLabel, 0, 1, 1, 1, GridBagConstraints.EAST, GridBagConstraints.NONE);
		
		streetText = new JTextField(30);	
		this.addComp(thePanel, streetText, 1, 1, 2, 1, GridBagConstraints.WEST, GridBagConstraints.NONE);
		...
		genderBox.add(maleRadio);
		genderBox.add(femaleRadio);
		genderBox.setBorder(BorderFactory.createTitledBorder("Sex"));
		addComp(thePanel, genderBox, 3, 0, 2, 1, GridBagConstraints.WEST, GridBagConstraints.NONE);
