...
public class FileTutorial extends JFrame {
	...
	public static void main(String[] args){
		...
		randomDir = new File("/Users/glen/Documents/Codes/workspace/Ch12 "
				+ "- Exceptions and Advanced File IO/src/directory");
		...
		randomFile2 = new File("/Users/glen/Documents/Codes/workspace/Ch12 "
				+ "- Exceptions and Advanced File IO/src/random2.txt");
		...
		if (randomFile.exists()) {
			...
			try {
				File.createTempFile("doop", ".txt", randomDir);
			} 
			catch (IOException e) {
		...
		//Cannot delete if contains file
		if(randomDir.delete()){
			System.out.println("Directory Deleted");
		}
		else {
			System.out.println("Please clear the directory");
		}
