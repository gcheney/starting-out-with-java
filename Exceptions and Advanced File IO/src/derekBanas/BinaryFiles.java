...
public class BinaryFiles {
	...
	public static void main(String[] args){
		...
		DataOutputStream custOutput = createFile("/Users/glen/Documents/Codes/workspace/Ch12"
				+ " - Exceptions and Advanced File IO/src/customers.dat");
	...
	private static DataOutputStream createFile(String fileName){
		...
		try{
			...
			DataOutputStream infoToWrite = new DataOutputStream(
							new BufferedOutputStream(new FileOutputStream(listOfNames, false)));
	...
	private static void createCustomers(Customer customer, DataOutputStream custOutput){
		...
		try
		{
			...
			custOutput.writeUTF(customer.getCustName()); 
			
			// Writes an Integer 
			custOutput.writeInt(customer.getCustAge()); 
			
			// Writes a Double
			custOutput.writeDouble(customer.getCustDebt()); 
			
			// Writes a Boolean 
			custOutput.writeBoolean(customer.owesMoney()); 
					
			// Writes a Character
			custOutput.writeChar(customer.getCustSex());
	...
	private static void getFileInfo(){
		...
		File listOfNames = new File("/Users/glen/Documents/Codes/workspace/Ch12"
				+ " - Exceptions and Advanced File IO/src/customers.dat");
