...
public class IOTutorial{
	...
	public static void main(String[] args){
		...
		PrintWriter custOutput = createFile("/Users/glen/Documents/Codes/workspace/Ch12"
				+ " - Exceptions and Advanced File IO/src/customers.txt");
	...
	private static void createCustomers(Customer customer, PrintWriter custOutput){
		...
		String custInfo = customer.firstName + " " + customer.lastName + " " 
					+ Integer.toString(customer.custAge);
		
		// Writes the string to the file		
		custOutput.write(custInfo + "\n");		
	}
	...
	private static void getFileInfo(){
		...
		try {
			...
			while(custInfo != null) {
				...
				System.out.print("Customer " + indivCustData[0] + " " 
									+ indivCustData[1] + " is " + custAge +"\n");	
